                ...
                <!--
                    ...
                    <nav id="sideNav"><!-- MAIN MENU -->
                        <ul class="nav nav-list">
                            ...
                            @can(['research-list','research-create','research-edit','research-delete'])
                            <li class="{{ in_array(\Request::segment(1),array('research')) ? 'active' : '' }}"><!-- dashboard -->
                                <a class="research" href="{{ route('research.index') }}">
                                    <i class="main-icon fa fa-solid fa-book"></i> <span>Research
                            ...
                            @can(['analyst-list','analyst-create','analyst-edit','analyst-delete'])
                            <li class="{{ in_array(\Request::segment(1),array('analyst')) ? 'active' : '' }}"><!-- dashboard -->
                                <a class="analyst" href="{{ route('analyst.index') }}">
                                    <i class="main-icon fa fa-solid fa-book"></i> <span>Analyst</span>
                                </a>
                            </li>
                            @endcan

                            @can(['role-finance-menu'])
                            <li class="{{ in_array(\Request::segment(1),array('finance')) ? 'active' : '' }}"><!-- dashboard -->
                                <a class="research" href="{{ route('research.index') }}">
                                    <i class="main-icon fa fa-solid fa fa-line-chart"></i> <span>Finance
                                    </span>
                                </a>
                            </li>
                            @endrole
